...
%---------------------------------------------------------
  \cvskill
    ...
    {Author: \textbf{spatial-gpu} (GPU spatial kernels, Python). Main contributor: \textbf{ridger} (R; initiated by B. Ru). Contributor: \textbf{secactpy}, \textbf{secact}, \textbf{spacet} (Jiang Lab activity-inference stack).}
