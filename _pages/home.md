...
- **Cell–cell communication and cytokine-activity inference.** Open-source tools for regression-based activity inference from transcriptomic data. I am the author of [spatial-gpu](https://github.com/psychemistz/spatial-gpu) (GPU-accelerated spatial kernels), main contributor to [ridger](https://github.com/beibeiru/ridger) (R; initiated by B. Ru), and a contributor to [secactpy](https://github.com/data2intelligence/secactpy) — part of the activity-inference stack developed in the Jiang Lab at NCI.
